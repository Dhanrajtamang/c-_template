...
// configuration step. It creates a namespace called `c__template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", c__template::cmake::project_name, c__template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", c__template::cmake::project_version);
      return EXIT_SUCCESS;
    }
